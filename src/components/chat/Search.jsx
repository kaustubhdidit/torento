  ...
  return (
    <div className="search">
      ...
      {user && (
        ...
        <span className="clickHere" style={{fontWeight:'bold',backgroundImage: "linear-gradient(to right, #4FDCE4, #E7BF6A)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent"}}>Click below to chat with..</span>
